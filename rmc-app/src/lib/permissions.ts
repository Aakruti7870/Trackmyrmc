...
const ADMIN_PATHS = ['/', '/orders', '/dispatch', '/clients', '/vehicles', '/drivers', '/batch-report', '/mix-design', '/reports', '/challans', '/shift-report', '/recurring', '/users', '/activity-log', '/audit-log', '/profile', '/kiosk'];

export const ROLE_ALLOWED_PATHS: Record<Role, string[]> = {
  authority:      ADMIN_PATHS,
  admin:          ADMIN_PATHS,
  dispatcher:     ['/', '/orders', '/dispatch', '/clients', '/vehicles', '/drivers', '/reports', '/challans', '/shift-report', '/recurring', '/profile', '/kiosk'],
