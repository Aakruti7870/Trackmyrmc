...
- **+91 97020 27870** — phone id `1223857314133530`, WABA `1336143745078768`, owned by `krushna_bade12`, type **WhatsApp Business *app* (SMB)**. CANNOT use Cloud API (SMB block). This was the app's original stale phone id — it never could have worked. Dead end.
