...
const KYC_ENV = ['KYC_ENABLED', 'KYC_BASE_URL', 'KYC_API_KEY', 'KYC_API_SECRET', 'KYC_API_VERSION', 'KYC_PROVIDER', 'APP_URL', 'PUBLIC_URL'] as const;
...
function stubSandbox(opts: { aadhaar?: () => { status: number; body: unknown } } = {}) {
