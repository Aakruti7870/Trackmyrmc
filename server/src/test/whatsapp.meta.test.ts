...
const { sendWhatsAppTemplate, metaWhatsAppConfig, isWhatsAppMessagingConfigured } =
  await import('../lib/whatsapp.js');
...
function stubFetch(impl: () => Promise<Response> | Response): Captured[] {
