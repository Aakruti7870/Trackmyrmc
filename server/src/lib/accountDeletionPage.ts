...
<div class="retention-wrap"><table class="retention-table">
...
<label class="check"><input id="confirmed" name="confirmed" type="checkbox" required><span>I confirm that I want to permanently delete my TrackMyRMC account and associated personal data.</span></label>
...
</main><footer>TrackMyRMC · com.trackmyrmc.concreteking · &copy; GOLD-e Tech</footer></div>
