...
export class ObjectStorageService {
    ...
    // Uploads a raw buffer (e.g. a decoded proof-of-delivery photo) directly to
    // the private object directory from the server, and returns the normalized
    // /objects/... entity path to persist in the database.
    ...
    // Generates a short-lived, self-authenticating GET URL for an object entity
    // path (/objects/...). Used to render private images in the browser without
    // exposing the bucket publicly or routing bytes through the API.
    async getObjectEntityDownloadURL(objectPath, ttlSec = 3600) {
