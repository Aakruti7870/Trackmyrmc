...
async function seed() {
    ...
    const plantRows = await db.insert(schema.plants).values([
        ...
        // Panvel / Raigad belt onboarding leads — dense coverage around Panvel, Taloja
        // MIDC, Kharghar, Kalamboli, Ulwe, Uran, Khopoli, Pen, Patalganga, Rasayani.
        // Locality-level coordinates; contact/GST are placeholders filled at onboarding.
        { plantCode: 'PLT-012', name: 'Panvel Ready Mix Concrete', address: 'New Panvel East, Sector 18', city: 'Panvel', contactNumber: '9820011012', latitude: '18.98940000', longitude: '73.11750000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '06:00', closeTime: '21:00' },
        { plantCode: 'PLT-013', name: 'Kalamboli Concrete Works', address: 'Kalamboli Steel Market Rd', city: 'Kalamboli', contactNumber: '9820011013', latitude: '19.04500000', longitude: '73.09900000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:30' },
        { plantCode: 'PLT-014', name: 'Kamothe RMC Suppliers', address: 'Sector 34, Kamothe', city: 'Kamothe', contactNumber: '9820011014', latitude: '19.02200000', longitude: '73.09700000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 25, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '07:00', closeTime: '20:00' },
        { plantCode: 'PLT-015', name: 'Kharghar UltraMix Concrete', address: 'Sector 12, Kharghar', city: 'Kharghar', contactNumber: '9820011015', latitude: '19.04700000', longitude: '73.06990000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '06:00', closeTime: '21:00' },
        { plantCode: 'PLT-016', name: 'Kharghar Valley ReadyMix', address: 'Sector 35, Kharghar', city: 'Kharghar', contactNumber: '9820011016', latitude: '19.03300000', longitude: '73.08100000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-017', name: 'Taloja Industrial RMC', address: 'MIDC Taloja Phase 1', city: 'Taloja', contactNumber: '9820011017', latitude: '19.08300000', longitude: '73.10100000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '05:30', closeTime: '22:00' },
        { plantCode: 'PLT-018', name: 'Taloja Phase-2 Premix', address: 'MIDC Taloja Phase 2', city: 'Taloja', contactNumber: '9820011018', latitude: '19.07000000', longitude: '73.11500000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-25', 'M-30', 'M-35', 'M-40'], openTime: '05:30', closeTime: '22:00' },
        { plantCode: 'PLT-019', name: 'Khandeshwar Concrete Hub', address: 'Khandeshwar, Panvel', city: 'Panvel', contactNumber: '9820011019', latitude: '19.00500000', longitude: '73.11000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:30' },
        { plantCode: 'PLT-020', name: 'Ulwe Coastal ReadyMix', address: 'Sector 19, Ulwe', city: 'Ulwe', contactNumber: '9820011020', latitude: '18.98700000', longitude: '73.02400000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '06:00', closeTime: '21:00' },
        { plantCode: 'PLT-021', name: 'Dronagiri Port RMC', address: 'Dronagiri Node, Uran', city: 'Dronagiri', contactNumber: '9820011021', latitude: '18.90000000', longitude: '72.99000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 40, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '05:30', closeTime: '22:00' },
        { plantCode: 'PLT-022', name: 'Sagar ReadyMix — Ulwe', address: 'Sector 5, Ulwe', city: 'Ulwe', contactNumber: '9820011022', latitude: '18.97500000', longitude: '73.03000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-023', name: 'Roadpali Concrete Co', address: 'Roadpali, Kalamboli', city: 'Kalamboli', contactNumber: '9820011023', latitude: '19.02500000', longitude: '73.09300000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 25, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '07:00', closeTime: '20:00' },
        { plantCode: 'PLT-024', name: 'Adai Green Concrete', address: 'Adai Village, Panvel', city: 'Panvel', contactNumber: '9820011024', latitude: '18.97000000', longitude: '73.14000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-025', name: 'Vichumbe Ready Mix', address: 'Vichumbe, New Panvel', city: 'Panvel', contactNumber: '9820011025', latitude: '18.99500000', longitude: '73.13000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 25, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '07:00', closeTime: '19:30' },
        { plantCode: 'PLT-026', name: 'Shedung Highway RMC', address: 'Mumbai-Pune Expressway, Shedung', city: 'Panvel', contactNumber: '9820011026', latitude: '18.95500000', longitude: '73.17000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:00', closeTime: '21:00' },
        { plantCode: 'PLT-027', name: 'Rasayani ReadyMix', address: 'Rasayani, Raigad', city: 'Rasayani', contactNumber: '9820011027', latitude: '18.82000000', longitude: '73.13000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:00', closeTime: '20:30' },
        { plantCode: 'PLT-028', name: 'Patalganga MIDC Concrete', address: 'MIDC Patalganga', city: 'Patalganga', contactNumber: '9820011028', latitude: '18.84000000', longitude: '73.17000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '05:30', closeTime: '21:30' },
        { plantCode: 'PLT-029', name: 'Pen Konkan ReadyMix', address: 'Pen-Alibaug Rd, Pen', city: 'Pen', contactNumber: '9820011029', latitude: '18.73700000', longitude: '73.09600000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:00', closeTime: '20:00' },
        { plantCode: 'PLT-030', name: 'Khopoli Ghat Concrete', address: 'Mumbai-Pune Highway, Khopoli', city: 'Khopoli', contactNumber: '9820011030', latitude: '18.78600000', longitude: '73.34500000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 40, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:00', closeTime: '20:30' },
        { plantCode: 'PLT-031', name: 'Apta Junction RMC', address: 'Apta, Panvel-Pen Rd', city: 'Apta', contactNumber: '9820011031', latitude: '18.86500000', longitude: '73.10500000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-032', name: 'Mohopada ReadyMix', address: 'Mohopada, Rasayani', city: 'Mohopada', contactNumber: '9820011032', latitude: '18.85000000', longitude: '73.15000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-033', name: 'Chowk Hills Concrete', address: 'Chowk, Khalapur', city: 'Chowk', contactNumber: '9820011033', latitude: '18.84000000', longitude: '73.30000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-15', 'M-20', 'M-25'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-034', name: 'Uran Bori RMC', address: 'Bori Pakhadi, Uran', city: 'Uran', contactNumber: '9820011034', latitude: '18.87000000', longitude: '72.95000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '06:00', closeTime: '21:00' },
        { plantCode: 'PLT-035', name: 'Nere Valley Concrete', address: 'Nere, Panvel', city: 'Panvel', contactNumber: '9820011035', latitude: '19.03000000', longitude: '73.13000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 25, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '07:00', closeTime: '19:30' },
        { plantCode: 'PLT-036', name: 'Karanjade Ready Mix', address: 'Karanjade, New Panvel', city: 'Panvel', contactNumber: '9820011036', latitude: '18.99500000', longitude: '73.10500000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 25, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-037', name: 'Taloje Panchanand RMC', address: 'Taloje Panchanand', city: 'Taloja', contactNumber: '9820011037', latitude: '19.06000000', longitude: '73.10000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:30' },
        { plantCode: 'PLT-038', name: 'Navade Concrete Works', address: 'Navade, Panvel', city: 'Panvel', contactNumber: '9820011038', latitude: '19.05000000', longitude: '73.11000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-039', name: 'Sukhapur ReadyMix', address: 'Sukhapur, Panvel', city: 'Panvel', contactNumber: '9820011039', latitude: '18.96000000', longitude: '73.15000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '07:00', closeTime: '19:30' },
        { plantCode: 'PLT-040', name: 'Koproli Coastal Concrete', address: 'Koproli, Uran', city: 'Uran', contactNumber: '9820011040', latitude: '18.85000000', longitude: '72.98000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 35, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:00', closeTime: '20:30' },
        { plantCode: 'PLT-041', name: 'Wavanje RMC Plant', address: 'Wavanje, Panvel', city: 'Panvel', contactNumber: '9820011041', latitude: '19.01000000', longitude: '73.15000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-042', name: 'Pargaon Premix Concrete', address: 'Pargaon, Panvel', city: 'Panvel', contactNumber: '9820011042', latitude: '18.89000000', longitude: '73.20000000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 30, grades: ['M-15', 'M-20', 'M-25', 'M-30'], openTime: '06:30', closeTime: '20:00' },
        { plantCode: 'PLT-043', name: 'Belapur Harbour ReadyMix', address: 'Sector 23, CBD Belapur', city: 'Belapur', contactNumber: '9820011043', latitude: '19.02000000', longitude: '73.04200000', plantStatus: 'approved', isActive: true, locationVerified: true, deliveryRadiusKm: 28, grades: ['M-20', 'M-25', 'M-30', 'M-35', 'M-40'], openTime: '06:30', closeTime: '21:00' },
