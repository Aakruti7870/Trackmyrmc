...
function LiveTrackingMap() {
  return (
    <div style={{
      ...
      {/* plant marker */}
      <Marker x={70} y={282} color="var(--blue)" label="Plant" icon={<Factory size={14} />} />
      {/* site marker */}
      <Marker x={492} y={52} color="var(--green)" label="Your Site" icon={<MapPin size={14} />} />
      {/* live tracking card */}
      <div style={{
...
function Marker({ x, y, color, label, icon }: { x: number; y: number; color: string; label: string; icon: React.ReactNode }) {
  return (
...
export function Landing() {
  ...
  const btnGold: React.CSSProperties = {
    ...
    background: "linear-gradient(160deg,#f7c948,#e0a91f)", color: "#0a1322",
    boxShadow: "0 14px 30px -12px rgba(247,201,72,.7)",
  };
  ...
  return (
    <div className="ck" style={{ minHeight: "100vh", background: "var(--bg)", overflowX: "hidden" }}>
      {/* NAV */}
      <header style={{ position: "sticky", top: 0, zIndex: 30,
        ...
        <div style={{ ...section, display: "flex", alignItems: "center", justifyContent: "space-between", height: 74 }}>
          ...
          <nav style={{ display: "flex", alignItems: "center", gap: 28 }}>
            <a style={{ color: "var(--muted)", fontWeight: 600, fontSize: 14.5, textDecoration: "none" }}>Why Us</a>
            <a style={{ color: "var(--muted)", fontWeight: 600, fontSize: 14.5, textDecoration: "none" }}>Live Feed</a>
            <a style={{ color: "var(--muted)", fontWeight: 600, fontSize: 14.5, textDecoration: "none" }}>Contact</a>
            <button style={btnGold}>Get Started <ArrowRight size={16} /></button>
          </nav>
        </div>
      </header>
      ...
      <section style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ ...section, position: "relative", padding: "64px 24px 72px",
          ...
          <div className="ck-fade">
            ...
            <h1 style={{ fontSize: 58, lineHeight: 1.03, fontWeight: 800, letterSpacing: -1.5, margin: "20px 0 0" }}>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginTop: 28 }}>
              <button style={btnGold}>Find Nearby Plants <ArrowRight size={16} /></button>
          ...
          <div className="ck-fade" style={{ animationDelay: ".15s", height: 420 }}>
            <LiveTrackingMap />
          </div>
        </div>
      </section>
      ...
      {/* WHY */}
      <section style={{ ...section, padding: "20px 24px 12px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }} className="ck-feat-grid">
          {FEATURES.map((f, i) => (
            <button key={f.title} onClick={() => setOpenFeature(i)} className="ck-card-hover"
              style={{ ...panel, textAlign: "left", cursor: "pointer", padding: 20, color: "var(--text)" }}>
      ...
      {/* CONTACT / ONBOARDING */}
      <section style={{ ...section, padding: "64px 24px 28px" }}>
        <div style={{ ...panel, padding: 36, display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 32, alignItems: "center",
          ...
          <div style={{ position: "relative" }}>
            ...
            <button style={{ ...btnGold, marginTop: 22 }}>Onboard Your Plant <ArrowRight size={16} /></button>
          </div>
...
function Modal({ children, onClose, wide }: { children: React.ReactNode; onClose: () => void; wide?: boolean }) {
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 50, display: "grid", placeItems: "center",
      ...
      <div onClick={(e) => e.stopPropagation()} className="ck-fade" style={{
