      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[420px] flex-col" style={{ background: BG }}>
        ...
        <main className="flex-1 overflow-y-auto px-4 pb-28">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[12px] text-white/80">Network dispatched today</p>
                <p className="text-[24px] font-extrabold leading-tight">
                  412.0 <span className="text-[14px] font-semibold text-white/85">m³</span>
                </p>
              </div>
            ...
            <div className="mt-3 flex gap-4 text-[12px]">
              <span className="text-white/85">
                <span className="font-bold text-white">5</span> plants
              </span>
              <span className="text-white/85">
                <span className="font-bold text-white">11</span> in transit
              </span>
              <span className="text-white/85">
                <span className="font-bold text-white">1</span> emergency
              </span>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2.5">
            <StatCard value="34" label="Users" color={BLUE} icon={<Users className="h-4 w-4" />} />
            <StatCard value="5" label="Plants" color={TEAL} icon={<Building2 className="h-4 w-4" />} />
          ...
          <div className="mt-3 rounded-2xl border bg-white p-4" style={{ borderColor: LINE }}>
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl" style={{ background: "#e7f9ee" }}>
              ...
              <div className="flex-1">
                ...
                <p className="text-[11.5px]" style={{ color: MUTED }}>
                  Meta Cloud API · 4 templates approved
                </p>
              </div>
            </div>
            <div className="mt-3 grid grid-cols-3 gap-2">
              <div className="rounded-lg px-2 py-2 text-center" style={{ background: "#f7f5f1" }}>
                <p className="text-[16px] font-extrabold" style={{ color: GREEN }}>
                  138
                </p>
              ...
              <div className="rounded-lg px-2 py-2 text-center" style={{ background: "#f7f5f1" }}>
                <p className="text-[16px] font-extrabold" style={{ color: AMBER }}>
                  3
                </p>
                <p className="text-[10px] font-medium" style={{ color: MUTED }}>
                  Retrying
              ...
              <div className="rounded-lg px-2 py-2 text-center" style={{ background: "#f7f5f1" }}>
                <p className="text-[16px] font-extrabold" style={{ color: RED }}>
                  1
                </p>
                <p className="text-[10px] font-medium" style={{ color: MUTED }}>
                  Failed
          ...
          <div className="mt-3 grid grid-cols-4 gap-x-2 gap-y-4">
            <QuickAction label="WhatsApp" tint={WA} bg="#e7f9ee" icon={<MessageCircle className="h-6 w-6" />} />
        ...
        >
          ...
          <TabItem icon={<MessageCircle className="h-5 w-5" />} label="WhatsApp" />
